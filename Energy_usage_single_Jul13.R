...
ggplot()+
  ...
  labs(x = "time", y = "kWh", title = "2024-07-13")
#######################################################
#tsla home
tsla_home <- sum(tsla_240713$Home..kW.)
tsla_powerwall <- sum(tsla_240713$Powerwall..kW.)
tsla_solar <- sum(tsla_240713$Solar..kW.)
tsla_grid <- sum(tsla_240713$Grid..kW.)
