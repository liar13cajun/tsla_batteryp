...
specific_date <- as.Date("2024-07-20")
...
#home
tsla_240720 <- read.csv("C:/Project_R/Tesla_battery/Tesla_battery/20240720_tsla.csv",encoding ="UTF-8")


tsla_240720 <- rownames_to_column(tsla_240720)

colnames(tsla_240720)[1] <- "ID"

tsla_240720$Home..kW.<-tsla_240720$Home..kW./10
tsla_240720$Powerwall..kW.<-tsla_240720$Powerwall..kW./10
tsla_240720$Solar..kW.<- tsla_240720$Solar..kW./10
tsla_240720$Grid..kW.<- tsla_240720$Grid..kW./10
...
### change here
df_join <- merge(tsla_240720,df_xx)
...
ggplot()+
  ...
  labs(x = "time", y = "kWh", title = "2024-07-20")
#######################################################
#tsla home
tsla_home <- sum(tsla_240720$Home..kW.)
tsla_powerwall <- sum(tsla_240720$Powerwall..kW.)
tsla_solar <- sum(tsla_240720$Solar..kW.)
tsla_grid <- sum(tsla_240720$Grid..kW.)
