...
specific_date <- as.Date("2024-07-21")
...
#home
tsla_240721 <- read.csv("C:/Project_R/Tesla_battery/Tesla_battery/20240721_tsla.csv",encoding ="UTF-8")


tsla_240721 <- rownames_to_column(tsla_240721)

colnames(tsla_240721)[1] <- "ID"

tsla_240721$Home..kW.<-tsla_240721$Home..kW./10
tsla_240721$Powerwall..kW.<-tsla_240721$Powerwall..kW./10
tsla_240721$Solar..kW.<- tsla_240721$Solar..kW./10
tsla_240721$Grid..kW.<- tsla_240721$Grid..kW./10
...
### change here
df_join <- merge(tsla_240721,df_xx)
...
ggplot()+
  ...
  labs(x = "time", y = "kWh", title = "2024-07-21")
#######################################################
#tsla home
tsla_home <- sum(tsla_240721$Home..kW.)
tsla_powerwall <- sum(tsla_240721$Powerwall..kW.)
tsla_solar <- sum(tsla_240721$Solar..kW.)
tsla_grid <- sum(tsla_240721$Grid..kW.)
