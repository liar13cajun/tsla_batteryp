...
specific_date <- as.Date("2024-07-22")
...
#home
tsla_240722 <- read.csv("C:/Project_R/Tesla_battery/Tesla_battery/20240722_tsla.csv",encoding ="UTF-8")


tsla_240722 <- rownames_to_column(tsla_240722)

colnames(tsla_240722)[1] <- "ID"

tsla_240722$Home..kW.<-tsla_240722$Home..kW./10
tsla_240722$Powerwall..kW.<-tsla_240722$Powerwall..kW./10
tsla_240722$Solar..kW.<- tsla_240722$Solar..kW./10
tsla_240722$Grid..kW.<- tsla_240722$Grid..kW./10
...
### change here
df_join <- merge(tsla_240722,df_xx)
...
ggplot()+
  ...
  labs(x = "time", y = "kWh", title = "2024-07-22")
#######################################################
#tsla home
tsla_home <- sum(tsla_240722$Home..kW.)
tsla_powerwall <- sum(tsla_240722$Powerwall..kW.)
tsla_solar <- sum(tsla_240722$Solar..kW.)
tsla_grid <- sum(tsla_240722$Grid..kW.)
